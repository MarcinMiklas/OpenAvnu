...
aaf_file_talker.ini,intf_nv_file_name=/home/marcin/Vladimir.wav,sr_class=$CLASS,map_nv_tx_rate=$RATE,report_seconds=0,map_nv_sparse_mode=0,max_transit_usec=2000
)
