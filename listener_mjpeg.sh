...
sudo ./openavb_harness -i -I $IFNAME -s $STREAMS -d 0 -a a0:36:9f:2d:01:ad \
mjpeg_gst_listener.ini,sr_class=$CLASS,map_nv_tx_rate=$RATE,report_seconds=0,map_nv_sparse_mode=0,intf_nv_audio_endian=big,max_transit_usec=2000
)
